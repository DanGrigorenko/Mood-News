...
// Порог непохожести живёт в module Непохожести, рядом с тем, что его считает
// (граница «копия / переписано» — часть непохожести, а не вердикта). Вердикт его
// берёт, а не объявляет (issue #28).
import { UNCHANGED_SIMILARITY_THRESHOLD } from './similarity.ts'
