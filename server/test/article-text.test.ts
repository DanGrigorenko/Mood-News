...
// Теста «неизвестный источник даёт null» больше нет: source — конечный набор из
// общего контракта (shared/api.mts), поэтому чужая лента не доходит до вызова —
// её ловит компилятор, а не рантайм-проверка (issue #30).
